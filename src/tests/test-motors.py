...
MOTOR2_FLIP_ROTATION = False # Change direction of rotation via software
...
try:
    ...
    control_motor(2, 0, "stop") # Ensure PWM is off and inputs are low

    
    time.sleep(1)

    # Unison Tests 
    print("Motors 1 and 2: Backward at 75% speed for 2 seconds")
